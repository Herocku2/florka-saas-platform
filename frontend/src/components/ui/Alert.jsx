    ...
    <div className={classes}>
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={`${title ? 'mt-2' : ''} text-sm ${textClasses[type]}`}>
            {children}
          </div>
        </div>
        {onClose && (
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                className={`inline-flex rounded-md p-1.5 ${textClasses[type]} hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-${type}-50 focus:ring-${type}-600`}
                onClick={onClose}
              >
